cordova.define("cordova-plugin-sslcertificatechecker.SSLCertificateChecker", function(require, exports, module) { "use strict";
  ...
  SSLCertificateChecker.prototype.checkInCertChain = function (successCallback, errorCallback, serverURL, allowedSHA1FingerprintOrArray, commonName) {
    if (typeof errorCallback != "function") {
      console.log("SSLCertificateChecker.find failure: errorCallback parameter must be a function");
      return
    }
    ...
    cordova.exec(successCallback, errorCallback, "SSLCertificateChecker", "check", [serverURL, true, fpArr, commonName]);
  };
